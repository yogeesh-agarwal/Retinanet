...
class ConvBlock(tf.keras.layers.Layer):
    def __init__(self , relu , bn , kernel_size , stride , padding , num_filters , **kwargs):
...
class ResnetBlock(tf.keras.layers.Layer):
    def __init__(self , residual , kernel_sizes , num_filters , paddings , strides , **kwargs):
        ...
        layer_index = 0
        if self.residual:
            self.left_conv = ConvBlock(False , True , kernel_sizes[layer_index] , strides[layer_index] , paddings[layer_index] , num_filters[layer_index])
            layer_index += 1
        self.right_conv_1 = ConvBlock(True , True , kernel_sizes[layer_index] , strides[layer_index] , paddings[layer_index] , num_filters[layer_index])
        layer_index += 1
        self.right_conv_2 = ConvBlock(True , True , kernel_sizes[layer_index] , strides[layer_index] , paddings[layer_index] , num_filters[layer_index])
        layer_index += 1
        self.right_conv_3 = ConvBlock(False , True , kernel_sizes[layer_index] , strides[layer_index] , paddings[layer_index] , num_filters[layer_index])
        layer_index += 1
